...
import { map, preloadImages } from "./utils";
...
const showGrid = () => {
  ...
  tl
    ...
    .to(
      DOM.gridItemTarget.querySelector(".oh__inner"),
      {
        duration: animationSettings.duration * 1.7,
        ease: animationSettings.ease,
        startAt: { yPercent: 101 },
...
const hideGrid = () => {
  ...
  for (let item of DOM.gridItems) {
    ...
    tl.to(
      ...
      item.querySelector(".oh__inner"),
      {
        duration: animationSettings.duration * 0.5,
        ease: animationSettings.ease,
        yPercent: 101,
        delay: delay,
      },
